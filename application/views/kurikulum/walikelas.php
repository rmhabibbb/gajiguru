        ...
        <?= $this->session->flashdata('msg2') ?>
          <div class="row"> 
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                       <div class="header"> 
                             <center><b>DATA WALI KELAS</b></center>
                        </div>
                        <div class="body">
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= base_url('kurikulum/add_walikelas')?>" method="Post"  >  
                                ...
                                <th>
                                   <select class="form-control" name="nip" required>
                                        ...
                                        <?php  foreach ($list_guru as $k): ?>  
                                            <?php if ($this->Wk_m->get_num_row(['nip' => $k->nip]) == 0) {  ?>
    ...
    <div class="modal fade" id="edit-<?=$row->id?>" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="<?= base_url('kurikulum/update_walikelas')?>" method="Post"  >  
                        <input type="hidden" name="id" value="<?=$row->id?>">
                         <table class="table table-bordered"> 
                            ...
                            <tr>   
                                <th>Kelas</th> 
                                <th> 
                                     <input type="text" name="kelas"  required class="form-control" value="<?=$row->kelas?>">
                                </th>  
                            </tr>  
                            <tr>   
                                <th>Keterangan</th> 
                        ...
                        <div class="modal-body"> 
                         ...
                         <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <form action="<?= base_url('kurikulum/delete_walikelas')?>" method="Post" >  
