    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="<?= base_url('operator/add_jammengajar')?>" method="Post"  >  
    ...
    <div class="modal fade" id="edit-<?=$row->id?>" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                  <form action="<?= base_url('operator/update_jammengajar')?>" method="Post"  >  
                        ...
                        <div class="modal-body"> 
                         ...
                         <div class="row">
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                                        ...
                                        <form action="<?= base_url('operator/delete_jammengajar')?>" method="Post" >  
